...
def print_draw_crop_rec_res( img_crop_list, img_name):
        ...
        for bno in range(bbox_num):
          ...
          crop_name_w = "./train_data/img_crop/{}".format(crop_name)
...
for img_file in img_files:
  ...
  image_file = './train_data/train_images/' +img_file.split('\t')[0]
  ...
  if not os.path.exists('./train_data/img_crop'):
    os.mkdir('./train_data/img_crop') 
